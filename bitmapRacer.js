...
class Car {
    ...
    mech2() {
        ...
        for (let i = 0; i < 4; i++) {
            ...
            if (car.U < .2) {//m,aybe use longitudinal velocity for damping thresh?
                wh.skidFac = 0;
...
let lookAhead = p.draw.lookAhead; //seconds
let panSpeed = p.draw.panSpeed;
...
let PPM = p.draw.pixPerMetre; // init scale, screen pixels per metre - pre zoom
